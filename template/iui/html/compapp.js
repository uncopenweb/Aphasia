...
dojo.declare('compapp',[], {
        ...
        start: function(audio) { 
            ...
            var imgTable2 = dojo.create("table",{id:"tTable",selected:"true",style:{"border-collapse":"collapse","border":"1px solid black","font-size": "75%","width":"99.9%","height":"20%"}, height:"20%"},footer);
