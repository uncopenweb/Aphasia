...
dojo.declare('compapp',[], {
        ...
        start: function(audio) { 
            ...
            var leftTable = dojo.create("table",{id:"sideTable",style:{"width":'12.5%',"height":'60px'},selected:"true"},dojo.body());
                ...
                dojo.forEach(leftPhrases, function(aPhrase) {
                    ...
                    var td = dojo.create("td",{id:"sidetd1",style:{"width":'60px', "height":"12%"}},tr);
