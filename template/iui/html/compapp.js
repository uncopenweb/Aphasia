...
dojo.declare('compapp',[], {
        ...
        start: function(audio) { 
            ...
            var imgTable2 = dojo.create("table",{id:"tTable",selected:"true",style:{"border-collapse":"collapse","border-top":"1px solid black","font-size": "75%","width":"99.9%","height":"100%"}},footer);
