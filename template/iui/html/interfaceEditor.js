    ...
    function step1 (ids) {
        ...
        var td1 = dojo.create("td",{className:"dataTable"},tr);
        var td2 = dojo.create("td",{className:"dataTable",innerHTML:"Interface Theme"},tr);
        var td3 = dojo.create("td",{className:"dataTable",innerHTML:"Id"},tr);
